...
class MessagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'message' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-09-14 15:58:04',
                'modified' => '2020-09-14 15:58:04',
            ],
        ];
        parent::init();
    }
